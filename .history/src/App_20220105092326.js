...
export default () => {
  ...
  return (
    <div className="page">
      ...
      <footer>
        Feito com muita dedicação pelo <a href="https://github.com/tomoliveira1" target="_blank">Weverton Oliveira</a> Projeto de estudo front-end
        Direitos de Imagem: netflix.com
